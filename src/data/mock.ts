...
export const navItems: NavItem[] = [
  ...
  { label: "Books", href: "/library/books", icon: "book", section: "library" },
  { label: "Aptitude Material", href: "/library/aptitude", icon: "aptitude", section: "library" },
  { label: "HackerRank", href: "/library/hackerrank", icon: "hackerrank", section: "library" },
  { label: "Podcast", href: "/library/podcast", icon: "podcast", section: "library" },
